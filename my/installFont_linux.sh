...
download_and_install_font() {
  ...
  wget  "$download_url" -O "$zip_file" || { echo "Error: Unable to download '$selected_font'."; return 1; }
...
brew install wget unzip fontconfig jq
# choose_font
font_choice="40"
# choose_extension
...
# choose_version
version=v3.4.0
download_and_install_font "JetBrainsMono"
